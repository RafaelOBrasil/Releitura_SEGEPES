...
export function Mobile_grafico_pizza() {
  return (
    <Card className="flex flex-col justify-center sm:hidden">
          ...
          <PieChart>
            ...
            <Pie
              ...
              label={({
                ...
                const radius = innerRadius + (outerRadius - innerRadius) * 1.3; // aumenta distância
